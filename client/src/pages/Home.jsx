...
import homeser from "../../public/service.json";
...
export const Home = () => {
  return (
    <>
        ...
        <section className="section-hero">
          <div className="container grid grid-two-cols">
            <div className="hero-content">
              ...
              <h1>Welcome to NPM init</h1>
              <p>
                Are you ready to take your business to the next level with
                cutting-edge IT solutions? Look no further! At NPM init, we
      ...
      {/* 3rd section  */}
      <section className="section-hero anal">
        <div className="container grid grid-two-cols">
          {/* hero images  */}
          <div className="hero-image">
            <img
